...
from app.services.shengsuanyun_video import ShengsuanConfirmedVideoRequest
...
def _run_generation(
    ...
    shengsuanyun_video_request: ShengsuanConfirmedVideoRequest | None = None,
) -> dict:
    """
    在后台线程中执行现有视频流水线。
...
def submit_generation(
    ...
    shengsuanyun_request_snapshot = shengsuanyun_video_request
    sm.state.update_task(
        task_id,
    ...
    try:
        _task_manager.add_task(
            ...
            shengsuanyun_video_request=shengsuanyun_request_snapshot,
        )
    except Exception as exc:
